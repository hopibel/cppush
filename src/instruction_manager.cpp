...
void InstructionManager::register_core() {
	...
	// common stack ops
	register_op(equal<Code_ptr>, "CODE.=", CODE | BOOL);
	...
	register_op(protected_pop<Code_ptr>, "CODE.POP", CODE);
	...
	register_op(dup<Code_ptr>, "CODE.DUP", CODE);
	...
	register_op(flush<Code_ptr>, "CODE.FLUSH", CODE);
	...
	register_op(rot<Code_ptr>, "CODE.ROT", CODE);
	...
	register_op(shove<Code_ptr>, "CODE.SHOVE", CODE | INT);
	...
	register_op(stackdepth<Code_ptr>, "CODE.STACKDEPTH", CODE | INT);
	...
	register_op(swap<Code_ptr>, "CODE.SWAP", CODE);
	...
	register_op(yank<Code_ptr>, "CODE.YANK", CODE | INT);
	...
	register_op(yankdup<Code_ptr>, "CODE.YANKDUP", CODE | INT);
