...
void InstructionManager::register_core() {
	...
	// common stack ops
	register_op(code_equal, "CODE.=", CODE | BOOL);
	...
	register_op(protected_code_pop, "CODE.POP", CODE);
	...
	register_op(code_dup, "CODE.DUP", CODE);
	...
	register_op(code_flush, "CODE.FLUSH", CODE);
	...
	register_op(code_rot, "CODE.ROT", CODE);
	...
	register_op(code_shove, "CODE.SHOVE", CODE | INT);
	...
	register_op(code_stackdepth, "CODE.STACKDEPTH", CODE | INT);
	...
	register_op(code_swap, "CODE.SWAP", CODE);
	...
	register_op(code_yank, "CODE.YANK", CODE | INT);
	...
	register_op(code_yankdup, "CODE.YANKDUP", CODE | INT);
