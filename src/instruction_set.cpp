...
const std::map<std::string, std::pair<unsigned (*)(Env&), Types>> core_instructions{
	...
	// int
	{"integer_+", {add<int>, Type::Int}},
	{"integer_-", {sub<int>, Type::Int}},
	{"integer_*", {mul<int>, Type::Int}},
	{"integer_/", {div<int>, Type::Int}},
	{"integer_%", {int_mod, Type::Int}},
	{"integer_<", {less_than<int>, Type::Int | Type::Bool}},
	{"integer_>", {greater_than<int>, Type::Int | Type::Bool}},
	...
	// float
	{"float_+", {add<double>, Type::Float}},
	{"float_-", {sub<double>, Type::Float}},
	{"float_*", {mul<double>, Type::Float}},
	{"float_/", {div<double>, Type::Float}},
	{"float_%", {float_mod, Type::Float}},
	{"float_<", {less_than<double>, Type::Float | Type::Bool}},
	{"float_>", {greater_than<double>, Type::Float | Type::Bool}},
	...
	// common stack ops
	{"code_=", {equal<Code_ptr>, Type::Code | Type::Bool}},
	{"integer_=", {equal<int>, Type::Int | Type::Bool}},
	{"float_=", {equal<double>, Type::Float | Type::Bool}},
	{"boolean_=", {equal<bool>, Type::Bool}},
	{"exec_=", {exec_equal, Type::Exec | Type::Bool}},
	...
	{"exec_shove", {exec_shove, Type::Exec | Type::Int}},
	...
	{"exec_stackdepth", {exec_stackdepth, Type::Exec | Type::Int}},
	...
	{"exec_yank", {exec_yank, Type::Exec | Type::Int}},
	...
	{"exec_yankdup", {exec_yankdup, Type::Exec | Type::Int}},
};
